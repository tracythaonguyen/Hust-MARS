# Lab 6 - Assignment 1
# mang kieu word nen bo nho cac phan tu cach nhau 4
...
main: 		la $a0,A 
		...
		nop
continue:
lock:		j lock	# vong lap vo han hoac dung syscall exit
		nop
end_of_main:
...
test: 		addi $t0,$t0,1		 #advance the index i (tang chi so i)
		slt $t5,$t0,$a1		#set$t5to1ifi<n (tiep tuc kiem tra dieu kien)
